!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(["exports"], e)
      : e(((t = "undefined" != typeof globalThis ? globalThis : t || self).inkjs = {}))
})(this, function (t) {
  "use strict"
  class e {
    constructor() {
    ...
    set componentsString(t) {
      ...
      "." == this._componentsString[0] &&
        ((this._isRelative = !0), (this._componentsString = this._componentsString.substring(1)))
  ...
  ;((e.parentId = "^"),
    ...
    (function (t) {
      function e(t, e) {
        if (!t)
          throw (void 0 !== e && console.warn(e), console.trace && console.trace(), new Error(""))
      }
  ...
  class m {
    ...
    CompactPathString(t) {
      let e = null,
        n = null
      if (t.isRelative)
        ((n = t.componentsString), (e = this.path.PathByAppendingPath(t).componentsString))
      else {
  ...
  class f {
    ...
    AppendFormat(t) {
      for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), i = 1; i < e; i++)
        n[i - 1] = arguments[i]
      this.string += t.replace(/{(\d+)}/g, (t, e) => (void 0 !== n[e] ? n[e] : t))
    }
    toString() {
      return this.string
    }
  ...
  class S extends Map {
    constructor() {
      if (
        ...
        if (!n.exists)
          throw new Error(
            "InkList origin could not be found in story when constructing new list: " + t,
          )
    ...
    static FromString(t, e) {
      var n
      if (null == t || "" == t) return new S()
      let i =
        null === (n = e.listDefinitions) || void 0 === n ? void 0 : n.FindSingleItemListWithName(t)
    ...
    AddItem(t) {
      ...
      if (null !== t) {
        ...
        if (null === this.origins) return p("this.origins")
        for (let t of this.origins) {
          if (null === n) return p("itemName")
          if (t.ContainsItemWithName(n)) {
            if (null != i)
              throw new Error(
                "Could not add the item " +
                  n +
        ...
        if (null == i) {
          ...
          {
            let t = S.FromString(n, e).orderedItems[0]
            this.Add(t.Key, t.Value)
          }
        } else {
          let t = new g(i.name, n),
            e = i.ValueForItem(t)
          this.Add(t, e)
        }
      }
    ...
    get originNames() {
      if (this.Count > 0) {
        null == this._originNames && this.Count > 0
          ? (this._originNames = [])
          : (this._originNames || (this._originNames = []), (this._originNames.length = 0))
        for (let [t] of this) {
    ...
    GreaterThanOrEquals(t) {
      return (
        0 != this.Count &&
        (0 == t.Count ||
          (this.minItem.Value >= t.minItem.Value && this.maxItem.Value >= t.maxItem.Value))
      )
    }
    LessThan(t) {
    ...
    LessThanOrEquals(t) {
      return (
        0 != t.Count &&
        (0 == this.Count ||
          (this.maxItem.Value <= t.maxItem.Value && this.minItem.Value <= t.minItem.Value))
      )
    }
    MaxAsList() {
    ...
    ListWithSubRange(t, e) {
      ...
      ;(Number.isInteger(t) ? (i = t) : t instanceof S && t.Count > 0 && (i = t.minItem.Value),
        Number.isInteger(e) ? (r = e) : e instanceof S && e.Count > 0 && (r = e.maxItem.Value))
      let a = new S()
  ...
  class C extends m {
    ...
    BadCastException(t) {
      return new y("Can't cast " + this.valueObject + " from " + this.valueType + " to " + t)
    }
  }
  class b extends C {
    constructor(t) {
  ...
  class E extends b {
    constructor(t) {
      ...
      this.value.length > 0 &&
        this.value
          .split("")
          .every((t) => " " == t || "\t" == t || ((this._isInlineWhitespace = !1), !1))
    }
    get valueType() {
      return i.String
    }
      ...
      if (t == i.Int) {
        let e = (function (t) {
          let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
            n = parseInt(t)
          return Number.isNaN(n) ? { result: e, exists: !1 } : { result: n, exists: !0 }
        })(this.value)
    ...
    constructor(t, e) {
      ;(super(null),
        t || e
          ? t instanceof S
            ? (this.value = new S(t))
            : t instanceof g && "number" == typeof e && (this.value = new S({ Key: t, Value: e }))
          : (this.value = new S()))
    }
  ...
  class x extends m {
    ...
    set countFlags(t) {
      ...
      ;((e & x.CountFlags.Visits) > 0 && (this.visitsShouldBeCounted = !0),
        ...
        (e & x.CountFlags.CountStartOnly) > 0 && (this.countingAtStartOnly = !0))
    }
    ...
    get internalPathToFirstLeafContent() {
      let t = [],
        n = this
      for (; n instanceof x; )
        n.content.length > 0 && (t.push(new e.Component(0)), (n = n.content[0]))
      return new e(t)
    }
    AddContent(t) {
    ...
    ContentAtPath(t) {
      ...
      for (let l = e; l < n; ++l) {
        ...
        let o = r.ContentWithPathComponent(e)
        if (null == o) {
          i.approximate = !0
          break
        }
    ...
    BuildStringOfHierarchy() {
      ...
      if (0 == arguments.length)
        return ((t = new f()), this.BuildStringOfHierarchy(t, 0, null), t.toString())
      t = arguments[0]
      let e = arguments[1],
        i = arguments[2]
      function r() {
      ...
      for (let n = 0; n < this.content.length; ++n) {
        ...
        if (a instanceof x) {
          ...
          (r(),
            a instanceof E
              ? (t.Append('"'), t.Append(a.toString().replace("\n", "\\n")), t.Append('"'))
              : t.Append(a.toString()))
      ...
      let a = new Map()
      for (let [t, e] of this.namedContent) this.content.indexOf(l(e, m)) >= 0 || a.set(t, e)
      if (a.size > 0) {
  ...
  !(function (t) {
    var e
    ;(((e = t.CountFlags || (t.CountFlags = {}))[(e.Start = 0)] = "Start"),
      (e[(e.Visits = 1)] = "Visits"),
      (e[(e.Turns = 2)] = "Turns"),
  ...
  class k extends m {
    ...
    constructor() {
      let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : k.CommandType.NotSet
  ...
  class F {
    constructor() {
      ;((this.container = null),
        (this.index = -1),
        2 === arguments.length && ((this.container = arguments[0]), (this.index = arguments[1])))
    }
    Resolve() {
      return this.index < 0
        ? this.container
    ...
    get targetPointer() {
      if (this._targetPointer.isNull) {
        ...
        if (this._targetPath.lastComponent.isIndex) {
          ...
          ;((this._targetPointer.container = t.parent instanceof x ? t.parent : null),
    ...
    toString() {
      ...
      if (null == this.targetPath) return "Divert(null)"
      {
        ...
        return (
          ...
          this.pushesToStack &&
            (this.stackPushType == r.Function ? t.Append(" function") : t.Append(" tunnel")),
          t.Append(" -> "),
  ...
  class j extends m {
    ...
    Call(t) {
      ...
      let n = this.CoerceValuesToSingleType(t),
        r = n[0].valueType
      return r == i.Int || r == i.Float || r == i.String || r == i.DivertTarget || r == i.List
        ? this.CallType(n)
        : null
    }
    CallType(t) {
    ...
    CallBinaryListOperation(t) {
      if (("+" == this.name || "-" == this.name) && t[0] instanceof O && t[1] instanceof w)
    ...
    CallListIncrementOperation(t) {
      ...
      for (let [t, a] of e.value) {
        ...
        if (null === e.value.origins)
          return p("NativeFunctionCall.CallListIncrementOperation listVal.value.origins")
    ...
    CoerceValuesToSingleType(t) {
      ...
      for (let r of t) {
        let t = l(r, b)
        ;(t.valueType > e && (e = t.valueType), t.valueType == i.List && (n = s(t, O)))
      }
      let r = []
      if (i[e] == i[i.List])
        for (let e of t) {
          ...
          if (t.valueType == i.List) r.push(t)
            ...
            if (t.valueType != i.Int) {
              ...
              throw new y("Cannot mix Lists and " + e + " values in this operation")
            }
            {
              let e = parseInt(t.valueObject)
              if (((n = l(n, O)), null === n.value))
                return p("NativeFunctionCall.CoerceValuesToSingleType specialCaseList.value")
              let i = n.value.originOfMaxItem
              if (null === i) return p("NativeFunctionCall.CoerceValuesToSingleType list")
              let a = i.TryGetItemWithValue(e, g.Null)
              if (!a.exists)
                throw new y("Could not find List item with the value " + e + " in " + i.name)
              {
    ...
    static GenerateNativeFunctionsIfNecessary() {
      if (null == this._nativeFunctions) {
        ;((this._nativeFunctions = new Map()),
          ...
          this.AddListBinaryOp(this.GreaterThanOrEquals, (t, e) => t.GreaterThanOrEquals(e)),
          this.AddListBinaryOp(this.LessThanOrEquals, (t, e) => t.LessThanOrEquals(e)),
    ...
    static AddOpToNativeFunc(t, e, n, i) {
      ...
      ;(r || ((r = new j(t, e)), this._nativeFunctions.set(t, r)), r.AddOpFuncForType(n, i))
    }
  ...
  class G extends m {
    ...
    Clone() {
      ...
      return (
        ...
        null !== this.threadAtGeneration && (t.threadAtGeneration = this.threadAtGeneration.Copy()),
        t
      )
    }
  }
  ...
  class q {
    ...
    static WriteDictionaryRuntimeObjs(t, e) {
      t.WriteObjectStart()
      for (let [n, i] of e)
        (t.WritePropertyStart(n), this.WriteRuntimeObject(t, i), t.WritePropertyEnd())
      t.WriteObjectEnd()
    }
    ...
    static WriteRuntimeObject(t, e) {
      ...
      if (d)
        return (
          ...
          null === d.value
            ...
            : (t.WriteProperty("^->", d.value.componentsString), void t.WriteObjectEnd())
        )
      let m = s(e, N)
      if (m)
        return (
      ...
      if (S) {
        ...
        return (
          null != e ? t.WriteProperty("CNT?", e) : t.WriteProperty("VAR?", S.name),
          void t.WriteObjectEnd()
        )
      }
      let y = s(e, D)
      ...
      if (s(e, R)) return void t.Write("void")
      let v = s(e, B)
      if (v) return (t.WriteObjectStart(), t.WriteProperty("#", v.text), void t.WriteObjectEnd())
      let C = s(e, G)
      if (!C) throw new Error("Failed to convert runtime object to Json token: " + e)
    ...
    static JTokenToRuntimeObject(t) {
      if (("number" == typeof t && !isNaN(t)) || "boolean" == typeof t) return b.Create(t)
      if ("string" == typeof t) {
        let e = t.toString()
        const n = /^([0-9]+.[0-9]+f)$/.exec(e)
        if (n) return new T(parseFloat(n[0]))
        let i = e[0]
        if ("^" == i) return new E(e.substring(1))
        if ("\n" == i && 1 == e.length) return new E("\n")
        if ("<>" == e) return new I()
        for (let t = 0; t < q._controlCommandNames.length; ++t) {
          if (e == q._controlCommandNames[t]) return new k(t)
        }
        if (("L^" == e && (e = "^"), j.CallExistsWithName(e))) return j.CallWithName(e)
      ...
      if ("object" == typeof t && !Array.isArray(t)) {
        ...
        if (
          ((n = i["->"])
            ...
            : (n = i["f()"])
              ...
              : (n = i["->t->"])
                ? ((a = !0), (s = !0), (l = r.Tunnel))
                : (n = i["x()"]) && ((a = !0), (o = !0), (s = !1), (l = r.Function)),
          a)
        ) {
          let t = new W()
        ...
        let h = !1,
          u = !1
        if (
          ((n = i["VAR="]) ? ((h = !0), (u = !0)) : (n = i["temp="]) && ((h = !0), (u = !1)), h)
        ) {
          let t = n.toString(),
            e = !i.re,
            r = new D(t, e)
      ...
      if (null == t) return null
      throw new Error("Failed to convert token to runtime object: " + this.toJson(t, ["parent"]))
    }
    static toJson(t, e, n) {
    ...
    static WriteRuntimeContainer(t, e) {
      ...
      if ((l && t.WriteObjectStart(), null != i))
        for (let [e, n] of i) {
          let i = e,
            r = s(n, x)
          ;(t.WritePropertyStart(i), this.WriteRuntimeContainer(t, r, !0), t.WritePropertyEnd())
        }
    ...
    static JObjectToChoice(t) {
      ...
      return (
        ...
        (e.tags = this.JArrayToTags(t)),
        (e.isInvisibleDefault = !!t.isInvisibleDefault),
        e
      )
    }
    ...
    static WriteChoice(t, e) {
      ;(t.WriteObjectStart(),
        ...
        t.WriteProperty("isInvisibleDefault", e.isInvisibleDefault),
        this.WriteChoiceTags(t, e),
        t.WriteObjectEnd())
    }
    static WriteChoiceTags(t, e) {
      if (e.tags && e.tags.length > 0) {
        ;(t.WritePropertyStart("tags"), t.WriteArrayStart())
        for (const n of e.tags) t.Write(n)
  ...
  class U {
    ...
    constructor() {
      if (((this._threadCounter = 0), (this._startOfRoot = F.Null), arguments[0] instanceof Z)) {
        let t = arguments[0]
        ...
        ;((this._threadCounter = t._threadCounter), (this._startOfRoot = t._startOfRoot.copy()))
      }
    }
    Reset() {
      ;((this._threads = []),
        this._threads.push(new U.Thread()),
        this._threads[0].callstack.push(new U.Element(r.Tunnel, this._startOfRoot)))
    }
    SetJsonToken(t, e) {
      this._threads.length = 0
      let n = t.threads
    ...
    SetTemporaryVariable(t, e, n) {
      ...
      ;(a.exists && O.RetainListOriginsForAssignment(a.result, e), r.temporaryVariables.set(t, e))
    }
    ...
    get callStackTrace() {
      ...
      for (let e = 0; e < this._threads.length; e++) {
        ...
        for (let e = 0; e < n.callstack.length; e++) {
          n.callstack[e].type == r.Function ? t.Append("  [FUNCTION] ") : t.Append("  [TUNNEL] ")
          let i = n.callstack[e].currentPointer
          if (!i.isNull) {
            if ((t.Append("<SOMEWHERE IN "), null === i.container)) return p("pointer.container")
        ...
        if (
          ...
          for (let t of r) {
            ...
            if (void 0 !== o) {
              ...
              if (((l.container = t.container), (l.index = parseInt(a.idx)), null == t.obj))
                throw new Error(
      ...
      WriteJson(t) {
        ...
        for (let e of this.callstack) {
          if ((t.WriteObjectStart(), !e.currentPointer.isNull)) {
            if (null === e.currentPointer.container) return p("el.currentPointer.container")
            ;(t.WriteProperty("cPath", e.currentPointer.container.path.componentsString),
  ...
  class K extends class {} {
    ...
    StartVariableObservation() {
      ;((this._batchObservingVariableChanges = !0), (this._changedVariablesForBatchObs = new Set()))
    }
    CompleteVariableObservation() {
      ...
      if (null != this.patch)
        for (let e of this.patch.changedVariables) {
          let n = this.patch.TryGetGlobal(e, null)
          n.exists && t.set(e, n)
        }
      return ((this._changedVariablesForBatchObs = null), t)
    }
    NotifyObservers(t) {
      for (const [e, n] of t) this.variableChangedEvent(e, n)
    }
    get callStack() {
    ...
    $(t, e) {
      if (void 0 === e) {
        let e = null
        return null !== this.patch && ((e = this.patch.TryGetGlobal(t, null)), e.exists)
      ...
      }
      {
        if (void 0 === this._defaultGlobalVariables.get(t))
          throw new y(
            "Cannot assign to a variable (" + t + ") that hasn't been declared in the story",
          )
        let n = b.Create(e)
        if (null == n)
          throw null == e
            ? new Error("Cannot pass null to VariableState")
            : new Error("Invalid value passed to VariableState: " + e.toString())
        this.SetGlobal(t, n)
      }
    }
    constructor(t, e) {
      ...
      try {
        return new Proxy(this, {
          ...
          ownKeys: (t) => [
            ...new Set([...t._defaultGlobalVariables.keys(), ...t._globalVariables.keys()]),
          ],
          getOwnPropertyDescriptor: (t, e) => ({ enumerable: !0, configurable: !0, value: t.$(e) }),
        })
      } catch (t) {}
    }
    ApplyPatch() {
      ...
      if (null !== this._changedVariablesForBatchObs)
        for (let t of this.patch.changedVariables) this._changedVariablesForBatchObs.add(t)
      this.patch = null
    }
    SetJsonToken(t) {
    ...
    WriteJson(t) {
      ...
      for (let [e, n] of this._globalVariables) {
        ...
        ;(t.WritePropertyStart(i), q.WriteRuntimeObject(t, r), t.WritePropertyEnd())
      }
      t.WriteObjectEnd()
    }
    RuntimeObjectsEqual(t, e) {
      ...
      throw new Error(
        "FastRoughDefinitelyEquals: Unsupported runtime object type: " + t.constructor.name,
      )
    }
    ...
    GlobalVariableExistsWithName(t) {
      return (
        ...
        (null !== this._defaultGlobalVariables && this._defaultGlobalVariables.has(t))
      )
    }
    GetRawVariableWithName(t, e) {
      ...
      if (0 == e || -1 == e) {
        let e = null
        if (null !== this.patch && ((e = this.patch.TryGetGlobal(t, null)), e.exists))
          return e.result
        if (((e = v(this._globalVariables, t, null)), e.exists)) return e.result
        if (
      ...
      if (
        ...
        do {
          ;((t = s(this.GetRawVariableWithName(n, i), N)),
            null != t && ((n = t.variableName), (i = t.contextIndex), (r = 0 == i)))
        } while (null != t)
      }
    ...
    SetGlobal(t, e) {
      ...
      if (
        (null !== this.patch ? this.patch.SetGlobal(t, e) : this._globalVariables.set(t, e),
        ...
        if (this._batchObservingVariableChanges) {
          ...
          null !== this.patch
            ...
            : null !== this._changedVariablesForBatchObs && this._changedVariablesForBatchObs.add(t)
  ...
  class $ {
    static TextToDictionary(t) {
      return new $.Reader(t).ToDictionary()
    }
    static TextToArray(t) {
      return new $.Reader(t).ToArray()
    }
  }
  !(function (t) {
    t.Reader = class {
      constructor(t) {
        if (JSON.parse("0", (t, e, n) => null != n)) {
          const e = (t, e, n) =>
            Number.isInteger(e) && n.source.endsWith(".0") ? n.source + "f" : e
          this._rootObject = JSON.parse(t, e)
        } else {
          const e = t.replace(/(,\s*)([0-9]+\.[0]+)([,]*)/g, '$1"$2f"$3')
    ...
    class e {
      ...
      StartNewObject(e) {
        ;(e
          ...
          : this.Assert(
              this.state === t.Writer.State.Property || this.state === t.Writer.State.Array,
            ),
          this.state === t.Writer.State.Property && this.Assert(0 === this.childCount),
          (this.state !== t.Writer.State.Array && this.state !== t.Writer.State.Property) ||
            this.IncrementChildCount())
      }
      get state() {
      ...
      _addToCurrentObject(e) {
        ;(this.Assert(null !== this.currentCollection),
          this.state === t.Writer.State.Array
            ? (this.Assert(Array.isArray(this.currentCollection)), this.currentCollection.push(e))
            : this.state === t.Writer.State.Property &&
    ...
    ;((t.Writer = e),
      (function (e) {
        ...
        e.StateElement = class {
          constructor(e) {
            ;((this.type = t.Writer.State.None), (this.childCount = 0), (this.type = e))
          }
        }
      })((e = t.Writer || (t.Writer = {}))))
  })($ || ($ = {}))
  class X {
    ...
    WriteJson(t) {
      ;(t.WriteObjectStart(),
        ...
        t.WriteProperty("outputStream", (t) => q.WriteListRuntimeObjs(t, this.outputStream)))
      let e = !1
      for (let n of this.currentChoices) {
        ...
        ;((n.originalThreadIndex = n.threadAtGeneration.threadIndex),
          null === this.callStack.ThreadWithIndex(n.originalThreadIndex) &&
            (e || ((e = !0), t.WritePropertyStart("choiceThreads"), t.WriteObjectStart()),
  ...
  class Y {
    ...
    VisitCountAtPathString(t) {
      ...
      if (null !== this._patch) {
        ...
        if (((n = this._patch.TryGetVisitCount(i, 0)), n.exists)) return n.result
      }
    ...
    IncrementVisitCountForContainer(t) {
      ...
      let e = t.path.toString(),
        n = v(this._visitCounts, e, null)
      n.exists ? this._visitCounts.set(e, n.result + 1) : this._visitCounts.set(e, 1)
    }
    RecordTurnIndexVisitToContainer(t) {
      if (null !== this._patch) return void this._patch.SetTurnIndex(t, this.currentTurnIndex)
      let e = t.path.toString()
    ...
    get previousPathString() {
      ...
      return t.isNull ? null : null === t.path ? p("previousPointer.path") : t.path.toString()
    }
    get currentPointer() {
      ...
      if (this._outputStreamTagsDirty) {
        ...
        for (let n of this.outputStream) {
          ...
          if (null != i) {
            ...
            let t = s(n, B)
            null != t && null != t.text && t.text.length > 0 && this._currentTags.push(t.text)
          }
        }
        if (e.Length > 0) {
          let t = this.CleanOutputWhitespace(e.toString())
    ...
    constructor(t) {
      ;((this.kInkSaveStateVersion = 10),
        ...
        (this.story = t),
        (this._currentFlow = new X(this.kDefaultFlowName, t)),
      ...
      ;((this.storySeed = new z(e).next() % 100), (this.previousRandom = 0), this.GoToStart())
    }
    GoToStart() {
      this.callStack.currentElement.currentPointer = F.StartOf(this.story.mainContentContainer)
    }
    ...
    CopyAndStartPatching(t) {
      let e = new Y(this.story)
      if (
        ((e._patch = new H(this._patch)),
        (e._currentFlow.name = this._currentFlow.name),
        (e._currentFlow.callStack = new U(this._currentFlow.callStack)),
        e._currentFlow.outputStream.push(...this._currentFlow.outputStream),
        e.OutputStreamDirty(),
        t)
      )
        for (let t of this._currentFlow.currentChoices)
          e._currentFlow.currentChoices.push(t.Clone())
      else e._currentFlow.currentChoices.push(...this._currentFlow.currentChoices)
      if (null !== this._namedFlows) {
        e._namedFlows = new Map()
        for (let [t, n] of this._namedFlows)
          (e._namedFlows.set(t, n), (e._aliveFlowNamesDirty = !0))
        e._namedFlows.set(this._currentFlow.name, e._currentFlow)
      }
      return (
        this.hasError &&
          ((e._currentErrors = []), e._currentErrors.push(...(this.currentErrors || []))),
        this.hasWarning &&
          ((e._currentWarnings = []), e._currentWarnings.push(...(this.currentWarnings || []))),
        (e.variablesState = this.variablesState),
        (e.variablesState.callStack = e.callStack),
        (e.variablesState.patch = e._patch),
        e.evaluationStack.push(...this.evaluationStack),
        this.divertedPointer.isNull || (e.divertedPointer = this.divertedPointer.copy()),
        (e.previousPointer = this.previousPointer.copy()),
        (e._visitCounts = this._visitCounts),
        (e._turnIndices = this._turnIndices),
        (e.currentTurnIndex = this.currentTurnIndex),
        (e.storySeed = this.storySeed),
        (e.previousRandom = this.previousRandom),
        (e.didSafeExit = this.didSafeExit),
        e
      )
    }
    RestoreAfterPatch() {
    ...
    ApplyAnyPatch() {
      if (null !== this._patch) {
        ...
        for (let [t, e] of this._patch.visitCounts) this.ApplyCountChanges(t, e, !0)
        for (let [t, e] of this._patch.turnIndices) this.ApplyCountChanges(t, e, !1)
        this._patch = null
      }
    }
    ...
    WriteJson(t) {
      if (
        ...
        for (let [e, n] of this._namedFlows) t.WriteProperty(e, (t) => n.WriteJson(t))
      else t.WriteProperty(this._currentFlow.name, (t) => this._currentFlow.WriteJson(t))
      if (
        (t.WriteObjectEnd(),
        t.WritePropertyEnd(),
        t.WriteProperty("currentFlowName", this._currentFlow.name),
        t.WriteProperty("variablesState", (t) => this.variablesState.WriteJson(t)),
        t.WriteProperty("evalStack", (t) => q.WriteListRuntimeObjs(t, this.evaluationStack)),
        !this.divertedPointer.isNull)
      ) {
        if (null === this.divertedPointer.path) return p("divertedPointer")
        t.WriteProperty("currentDivertTarget", this.divertedPointer.path.componentsString)
      }
      ;(t.WriteProperty("visitCounts", (t) => q.WriteIntDictionary(t, this._visitCounts)),
        t.WriteProperty("turnIndices", (t) => q.WriteIntDictionary(t, this._turnIndices)),
    ...
    LoadJsonObj(t) {
      ...
      if (null != r) {
        ...
        for (let [n, i] of e) {
          let e = n,
            r = i,
            a = new X(e, this.story, r)
          if (1 === Object.keys(t).length) this._currentFlow = new X(e, this.story, r)
          else {
        ...
        ;((this._namedFlows = null),
          ...
          this._currentFlow.callStack.SetJsonToken(n.callstackThreads, this.story),
          (this._currentFlow.outputStream = q.JArrayToRuntimeObjList(n.outputStream)),
          (this._currentFlow.currentChoices = q.JArrayToRuntimeObjList(n.currentChoices)))
    ...
    PushToOutputStreamIndividual(t) {
      ...
      if (e) (this.TrimNewlinesFromOutputStream(), (i = !0))
        ...
        let s = -1
        if (((s = -1 != a && -1 != t ? Math.min(t, a) : -1 != a ? a : t), -1 != s)) {
          if (n.isNewline) i = !1
          ...
          n.isNewline &&
            ((!this.outputStreamEndsInNewline && this.outputStreamContainsContent) || (i = !1))
      }
      if (i) {
    ...
    get inStringEvaluation() {
      for (let t = this.outputStream.length - 1; t >= 0; t--) {
        ...
        if (e instanceof k && e.commandType == k.CommandType.BeginString) return !0
      }
      return !1
    }
    ...
    PopCallStack() {
      let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null
      ;(this.callStack.currentElement.type == r.Function && this.TrimWhitespaceFromFunctionEnd(),
    ...
    StartFunctionEvaluationFromGame(t, e) {
      ;(this.callStack.Push(r.FunctionEvaluationFromGame, this.evaluationStack.length),
          ...
          if (
            ...
            throw new Error(
              "ink arguments when calling EvaluateFunction / ChoosePathStringWithParameters must benumber, string, bool or InkList. Argument was " +
                (null === h(t[e]) ? "null" : t[e].constructor.name),
            )
    ...
    AddError(t, e) {
      e
        ...
        : (null == this._currentErrors && (this._currentErrors = []), this._currentErrors.push(t))
    }
    OutputStreamDirty() {
  ...
  class Z extends m {
    ...
    constructor() {
      ...
      if (arguments[0] instanceof x)
        ...
        let t = arguments[0]
        n = $.TextToDictionary(t)
      } else n = arguments[0]
      if (
        (null != e && (this._listDefinitions = new J(e)), (this._externals = new Map()), null !== n)
      ) {
        let t = n,
          e = t.inkVersion
        if (null == e)
        ...
        i != Z.inkVersionCurrent &&
          console.warn(
            `WARNING: Version of ink ${Z.inkVersionCurrent} used to build story doesn't match current version of engine (${i}). Non-critical, but recommend synchronising.`,
          )
        let r,
          a = t.root
        if (null == a)
          throw new Error("Root node for ink not found. Are you sure it's a valid .ink.json file?")
        ;((r = t.listDefs) && (this._listDefinitions = q.JTokenToListDefinitions(r)),
    ...
    ToJson(t) {
      ...
      if (
        ...
        t.WriteProperty("root", (t) => q.WriteRuntimeContainer(t, this._mainContentContainer)),
    ...
    ContinueInternal() {
      ...
      if ((this._recursiveContinueCount++, this._asyncContinueActive))
        this._asyncContinueActive && !e && (this._asyncContinueActive = !1)
      else {
      ...
      if (
        ((!i && this.canContinue) ||
          (null !== this._stateSnapshotAtLastNewline && this.RestoreStateSnapshot(),
          this.canContinue ||
          ...
          (this._sawLookaheadUnsafeFunctionAfterNewline = !1),
          1 == this._recursiveContinueCount &&
            (s = this._state.variablesState.CompleteVariableObservation()),
          (this._asyncContinueActive = !1),
        ...
        if (null === this.onError) {
          ...
          throw (
            ...
            this.state.hasError &&
              ...
              t.Append(1 == this.state.currentErrors.length ? " error" : " errors"),
              this.state.hasWarning && t.Append(" and ")),
            this.state.hasWarning &&
              (t.Append(`${this.state.currentWarnings.length}`),
              t.Append(1 == this.state.currentWarnings.length ? " warning" : " warnings"),
              this.state.hasWarning && t.Append(" and ")),
            t.Append(
              ". It is strongly suggested that you assign an error handler to story.onError. The first issue was: ",
            ),
            t.Append(
              this.state.hasError ? this.state.currentErrors[0] : this.state.currentWarnings[0],
            ),
            new y(t.toString())
          )
        }
        if (this.state.hasError) for (let t of this.state.currentErrors) this.onError(t, a.Error)
        if (this.state.hasWarning)
          for (let t of this.state.currentWarnings) this.onError(t, a.Warning)
        this.ResetErrors()
      }
      null != s && Object.keys(s).length > 0 && this._state.variablesState.NotifyObservers(s)
    }
    ContinueSingleStep() {
      if (
    ...
    CalculateNewlineOutputStateChange(t, e, n, i) {
      ...
      let r = e.length >= t.length && t.length > 0 && "\n" == e.charAt(t.length - 1)
      if (n == i && t.length == e.length && r) return Z.OutputStateChange.NoChange
      ...
      for (let n = t.length; n < e.length; n++) {
        let t = e.charAt(n)
        if (" " != t && "\t" != t) return Z.OutputStateChange.ExtendedBeyondNewline
      }
    ...
    RestoreStateSnapshot() {
      ;(null === this._stateSnapshotAtLastNewline && p("_stateSnapshotAtLastNewline"),
    ...
    CopyStateForBackgroundThreadSave() {
      if ((this.IfAsyncWeCant("start saving on a background thread"), this._asyncSaving))
        throw new Error(
          "Story is already in background saving mode, can't call CopyStateForBackgroundThreadSave again!",
        )
      let t = this._state
      return ((this._state = this._state.CopyAndStartPatching(!0)), (this._asyncSaving = !0), t)
    }
    ...
    Step() {
      ...
      this.NextContent()
      let l = s(i, k)
      l && l.commandType == k.CommandType.StartThread && this.state.callStack.PushThread()
    }
    VisitContainer(t, e) {
      ;(t.countingAtStartOnly && !e) ||
        (t.visitsShouldBeCounted && this.state.IncrementVisitCountForContainer(t),
    ...
    PopChoiceStringAndTags(t) {
      ...
      for (
        ;
        this.state.evaluationStack.length > 0 && null != s(this.state.PeekEvaluationStack(), B);
      ) {
    ...
    PerformLogicAndFlowControl(t) {
      ...
      if (t instanceof W) {
        ...
        if (e.hasVariableTarget) {
          ...
          if (null == n)
            this.Error(
              "Tried to divert using a target from a variable that could not be found (" + t + ")",
            )
          ...
          if (e.isExternal)
            return (this.CallExternalFunction(e.targetPathString, e.externalArgs), !0)
          this.state.divertedPointer = e.targetPointer.copy()
        }
        return (
          e.pushesToStack &&
            this.state.callStack.Push(e.stackPushType, void 0, this.state.outputStream.length),
          this.state.divertedPointer.isNull &&
            !e.isExternal &&
            (e && e.debugMetadata && null != e.debugMetadata.sourceName
              ? this.Error("Divert target doesn't exist: " + e.debugMetadata.sourceName)
      ...
      if (t instanceof k) {
        ...
        switch (e.commandType) {
          ...
          case k.CommandType.PopTunnel:
            let t = e.commandType == k.CommandType.PopFunction ? r.Function : r.Tunnel,
              n = null
            if (t == r.Tunnel) {
              let t = this.state.PopEvaluationStack()
              ;((n = s(t, P)),
                null === n &&
                  this.Assert(t instanceof R, "Expected void if ->-> doesn't override target"))
            }
            if (this.state.TryExitFunctionEvaluationFromGame()) break
            if (this.state.callStack.currentElement.type == t && this.state.callStack.canPop)
              (this.state.PopCallStack(),
                n && (this.state.divertedPointer = this.PointerAtPath(n.targetPath)))
            else {
              let e = new Map()
          ...
          case k.CommandType.Turns:
            this.state.PushEvaluationStack(new w(this.state.currentTurnIndex + 1))
            break
          ...
          case k.CommandType.Random: {
            ...
            let i = this.state.storySeed + this.state.previousRandom,
              r = new z(i).next(),
              a = (r % n) + e.value
            ;(this.state.PushEvaluationStack(new w(a)), (this.state.previousRandom = r))
            break
          }
          case k.CommandType.SeedRandom:
            ...
            ;((this.state.storySeed = c.value),
              ...
              this.state.PushEvaluationStack(new R()))
            break
          case k.CommandType.VisitIndex:
            let d = this.state.VisitCountForContainer(this.state.currentPointer.container) - 1
          ...
          case k.CommandType.Done:
            this.state.callStack.canPopThread
              ...
              : ((this.state.didSafeExit = !0), (this.state.currentPointer = F.Null))
            break
          ...
          case k.CommandType.ListFromInt:
            ...
            if (null === v)
              throw new y("Passed non-integer when creating a list element from a numerical value.")
            let _ = null
          ...
          case k.CommandType.ListRandom: {
            ...
            if (0 == e.Count) n = new S()
              ...
              if (null === l.Key.originName) return p("randomItem.Key.originName")
    ...
    EvaluateFunction(t) {
      ...
      return (
        null != this.onCompleteEvaluateFunction && this.onCompleteEvaluateFunction(t, e, s, l),
    ...
    CallExternalFunction(t, e) {
      ...
      if (
        ...
        a && !n.lookAheadSafe && null !== this._stateSnapshotAtLastNewline)
      )
      ...
      if (!a) {
        if (this.allowExternalFunctionFallbacks)
          return (
            ...
            this.state.callStack.Push(r.Function, void 0, this.state.outputStream.length),
    ...
    ValidateExternalBindings() {
      ...
      if (
        ...
        for (let [, e] of t.namedContent) this.ValidateExternalBindings(s(e, m), n)
      } else if (null != e) {
        let t = s(e, W)
        if (t && t.isExternal) {
    ...
    ObserveVariable(t, e) {
      if (
        ...
        throw new Error(
          "Cannot observe variable '" + t + "' because it wasn't declared in the ink story.",
        )
        ...
        if (null != e) {
          if (this._variableObservers.has(e))
            if (null != t) {
              ...
              null != n &&
                (n.splice(n.indexOf(t), 1), 0 === n.length && this._variableObservers.delete(e))
          ...
          for (let n of e) {
            ...
            null != e &&
              (e.splice(e.indexOf(t), 1), 0 === e.length && this._variableObservers.delete(n))
          }
        }
    }
    ...
    BuildStringOfHierarchy() {
      let t = new f()
      return (
        this.mainContentContainer.BuildStringOfHierarchy(t, 0, this.state.currentPointer.Resolve()),
        t.toString()
      )
    }
      ...
      if (!this.IncrementContentPointer()) {
        ...
        ;(this.state.callStack.CanPop(r.Function)
          ? (this.state.PopCallStack(r.Function),
            this.state.inExpressionEvaluation && this.state.PushEvaluationStack(new R()),
            (t = !0))
          : this.state.callStack.canPopThread
    ...
    IncrementContentPointer() {
      ...
      return (t || (e = F.Null), (this.state.callStack.currentElement.currentPointer = e.copy()), t)
    }
    ...
    NextSequenceShuffleIndex() {
      let t = s(this.state.PopEvaluationStack(), w)
      if (!(t instanceof w))
        return (this.Error("expected number of elements in sequence for shuffle index"), 0)
    ...
    Assert(t) {
      let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null
      if (0 == t)
        throw (null == e && (e = "Story assert"), new Error(e + " " + this.currentDebugMetadata))
    }
    get currentDebugMetadata() {
      let t,
        e = this.state.currentPointer
      if (!e.isNull && null !== e.Resolve() && ((t = e.Resolve().debugMetadata), null !== t))
        return t
      for (let n = this.state.callStack.elements.length - 1; n >= 0; --n)
        if (
          ((e = this.state.callStack.elements[n].currentPointer),
          !e.isNull && null !== e.Resolve() && ((t = e.Resolve().debugMetadata), null !== t))
        )
          return t
      for (let e = this.state.outputStream.length - 1; e >= 0; --e) {
        if (((t = this.state.outputStream[e].debugMetadata), null !== t)) return t
      }
      return null
    }
